...
class CategoriasProdutosTableTest extends TestCase
{
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('CategoriasProdutos') ? [] : ['className' => CategoriasProdutosTable::class];
        $this->CategoriasProdutos = TableRegistry::get('CategoriasProdutos', $config);
    }
